...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.request_matcher.fwssjrp' => 'getSecurity_RequestMatcher_FwssjrpService.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.fwssjrp' => true,
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.fwssjrp']) ? $this->services['security.request_matcher.fwssjrp'] : ($this->services['security.request_matcher.fwssjrp'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
