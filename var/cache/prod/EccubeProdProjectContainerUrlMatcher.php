...
class EccubeProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/adminsite')) {
            // admin_login
            if ('/adminsite/login' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/adminsite/s')) {
                // admin_homepage_sale
                if ('/adminsite/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/se')) {
                    // admin_homepage_nonstock
                    if ('/adminsite/search_nonstock' === $pathinfo) {
                    ...
                    if ('/adminsite/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/adminsite/setting/shop/csv') && preg_match('#^/adminsite/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/adminsite/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/adminsite/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/adminsite/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/adminsite/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/adminsite/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/adminsite/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/adminsite/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/adminsite/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/adminsite/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/adminsite/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/adminsite/setting/system')) {
                        // admin_setting_system_authority
                        if ('/adminsite/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/adminsite/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/adminsite/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/adminsite/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/adminsite/setting/system/member' === $pathinfo) {
                            ...
                            if ('/adminsite/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/adminsite/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/adminsite/setting/system/system' === $pathinfo) {
                            ...
                            if ('/adminsite/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/adminsite/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/adminsite/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/adminsite/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/shipping/preview_notify_mail') && preg_match('#^/adminsite/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/shipping/notify_mail') && preg_match('#^/adminsite/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/adminsite/store/plugin')) {
                    if (0 === strpos($pathinfo, '/adminsite/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/adminsite/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/adminsite/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/adminsite/store/plugin/api/search/page') && preg_match('#^/adminsite/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/adminsite/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/adminsite/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/store/plugin/api/delete') && preg_match('#^/adminsite/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/adminsite/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/adminsite/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/adminsite/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/adminsite/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/adminsite/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/adminsite/store/template')) {
                    // admin_store_template
                    if ('/adminsite/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/adminsite/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/adminsite/c')) {
                // admin_change_password
                if ('/adminsite/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/content')) {
                    if (0 === strpos($pathinfo, '/adminsite/content/block')) {
                        // admin_content_block
                        if ('/adminsite/content/block' === $pathinfo) {
                        ...
                        if ('/adminsite/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/adminsite/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/adminsite/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/content/file_')) {
                        // admin_content_file
                        if ('/adminsite/content/file_manager' === $pathinfo) {
                        ...
                        if ('/adminsite/content/file_view' === $pathinfo) {
                        ...
                        if ('/adminsite/content/file_delete' === $pathinfo) {
                        ...
                        if ('/adminsite/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/adminsite/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/content/layout')) {
                        // admin_content_layout
                        if ('/adminsite/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/content/news')) {
                        // admin_content_news
                        if ('/adminsite/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/content/news/page') && preg_match('#^/adminsite/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/adminsite/content/page')) {
                        // admin_content_page
                        if ('/adminsite/content/page' === $pathinfo) {
                        ...
                        if ('/adminsite/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/adminsite/customer')) {
                    // admin_customer
                    if ('/adminsite/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/adminsite/customer/page') && preg_match('#^/adminsite/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/adminsite/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/adminsite/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/adminsite/order')) {
                // admin_shipping_csv_import
                if ('/adminsite/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/adminsite/order/csv_template' === $pathinfo) {
                ...
                // admin_order_new
                if ('/adminsite/order/new' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/adminsite/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/order/search')) {
                    if (0 === strpos($pathinfo, '/adminsite/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/adminsite/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/order/search/customer/html/page') && preg_match('#^/adminsite/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/order/search/product')) {
                        // admin_order_search_product
                        if ('/adminsite/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/adminsite/order/search/product/page') && preg_match('#^/adminsite/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/adminsite/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/adminsite/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/adminsite/order/page') && preg_match('#^/adminsite/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/adminsite/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/order/export')) {
                    // admin_order_export_order
                    if ('/adminsite/order/export/order' === $pathinfo) {
                    ...
                    if ('/adminsite/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/adminsite/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/adminsite/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/adminsite/product')) {
                if (0 === strpos($pathinfo, '/adminsite/product/c')) {
                    if (0 === strpos($pathinfo, '/adminsite/product/category')) {
                        // admin_product_category
                        if ('/adminsite/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/adminsite/product/category/export' === $pathinfo) {
                        ...
                        if ('/adminsite/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/adminsite/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/adminsite/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/adminsite/product/class_name')) {
                        // admin_product_class_name
                        if ('/adminsite/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/adminsite/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/adminsite/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/adminsite/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/adminsite/product/csv_template') && preg_match('#^/adminsite/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/adminsite/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/adminsite/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/adminsite/product/page') && preg_match('#^/adminsite/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/product/product')) {
                    // admin_product_image_add
                    if ('/adminsite/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/adminsite/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/adminsite/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/adminsite/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/product/classes') && preg_match('#^/adminsite/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/adminsite/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/product/bulk/product-status') && preg_match('#^/adminsite/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/adminsite/product/tag')) {
                    // admin_product_tag
                    if ('/adminsite/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/adminsite/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/adminsite/product/tag/sort_no/move' === $pathinfo) {
